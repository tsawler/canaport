...
<h1>Edit CCELC Minutes</h1>

{{ Form::model($minute, array(
						'role' => 'form', 
						'name' => 'bookform', 'id' => 'bookform',
						'url' => array('admin/editminute', $minute->id )
						) 
		   )
}}
...
<div class="form-group">
    <div class="controls">
	    ...
	    <a class="btn-normal btn-danger" href="#!" onclick='confirmDelete({{$minute->id}})'>Delete this item</a>
    </div>
</div>
