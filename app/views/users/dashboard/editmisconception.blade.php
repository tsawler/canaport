...
<div class="container">
	...
	{{ Form::model($misconception, array(
							'role' => 'form', 
							'name' => 'bookform', 'id' => 'bookform',
							'url' => array('admin/editmisconception', $misconception->id )
							) 
			   )
	}}
	    ...
	    <div class="form-group">
		{{ Form::label('question', 'Myth', array('class' => 'control-label')); }}
	    ...
	    <div class="form-group">
		{{ Form::label('answer', 'Reality', array('class' => 'control-label')); }}
		<div class="controls" style='max-width: 650px;'>
	    ...
	    <div class="controls">
		    ...
		    <a class="btn-normal btn-danger" href="#!" onclick='confirmDelete({{$misconception->id}})'>Delete this Item</a>
	    </div>
</div>
<div>&nbsp;</div>
...
function confirmDelete(x){
	bootbox.confirm("Are you sure you want to delete this Item?", function(result) {
		if (result==true)
		{
			window.location.href = '/admin/deletemisconception/'+x;
		}
	});
}
